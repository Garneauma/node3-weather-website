...
const forecast = (longitude, latitude, callback) => {
    ...
    request({ url, json: true }, (error, {body}) => {
        if (error) {
            ...
            callback(undefined, body.weather[0].main + '. It is currently ' + Math.round(body.main.temp) + ' degrees out. It feels like ' + Math.round(body.main.feels_like) + ' degrees. Pressure is ' + body.main.pressure + ' hPa')
        }
    })
}
